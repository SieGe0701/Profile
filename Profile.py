...
with st.container():
    ...
    st.write("I am passionate about ML and DL implementations in medical and buisness fields")
    st.write("[Linked In >](https://www.linkedin.com/in/srinivas-prabhu-3b090b279/)")
...
with st.container():
    ...
    with image:
        st.image("https://t4.ftcdn.net/jpg/00/42/28/37/360_F_42283748_EiXhF88tPQVwPHgGzjjF8WPmsCtDLzLQ.jpg")
    with text:
...
with st.container():
        ...
        with img:
            st.image("https://img.freepik.com/free-vector/illustration-fake-news-concept_53876-40823.jpg?size=626&ext=jpg")
        with txt:
